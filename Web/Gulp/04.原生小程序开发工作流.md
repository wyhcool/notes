...
const xmlDirectionReplace = [
  ...
  },
  {
    ...
    str: isAlipay ? 'onTouchStart' : isWechat ? 'bindtouchstart' : isJd ? 'bindtouchstart' : '@touchstart'
  },
  {
    replaceStr: '@touchmove',
    str: isAlipay ? 'onTouchMove' : isWechat ? 'bindtouchmove' : isJd ? 'bindtouchmove' : '@touchmove'
  },
  {
    replaceStr: '@touchend',
    str: isAlipay ? 'onTouchEnd' : isWechat ? 'bindtouchend' : isJd ? 'bindtouchend' : '@click'
  },
  {
